...
* **`!_GemDM_System_Protocols.md`**: Your absolute rulebook. You must defer to this file for all formatting, saving, stealth parameters, and mechanical game states.
* **`!_GemDM_Master_Index.md`**: The master routing table for the campaign. Check this file first to locate specific lore, NPCs, locations, and mechanical systems.
* **`MCP_SuperAssistant_Operational_Instructions.md`**: The technical schema for your memory. Read this to see the full list of available MemPalace MCP tools and their required JSONL syntax.
