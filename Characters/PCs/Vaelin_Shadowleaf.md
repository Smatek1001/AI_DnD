---
last_updated: 2025-06-08T15:57:04
...
| Mage Hand        | Warlock          | Charisma             | 1 Bonus Action | 30 ft  | 1 minute                      | Functions as Mage Hand Legerdemain [[_DM_Instructions/House_Rules#VI. Specific Class/Race Modifications\|per house rules]].                                              |
...
- **Warlock Spell Slots:** Vaelin has 2 second-level spell slots, regained on a short or long rest. These can be used for _Charm Person_, _Hellish Rebuke_, _Disguise Self_, or _Detect Magic_ (if not using the racial free cast).
